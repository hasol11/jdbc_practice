...
public class TakenSubjectRepository {
	...
	public static int checkIsTakenSubject(String subject_name, int id) {
		...
		String query = "SELECT * " +
				...
				"WHERE sub.subject_name= " + "'" + subject_name + "'" + " AND s.login_id = " + id;
	...
	public static int insertTakenSubject(String subject_name, int id) {
		int result = 0;
		...
		int [] studentId=StudentRepository.isStudentExist(id);

		
		String query = "INSERT INTO taken_subject (student_id , subject_id, teacher_id) " +
				"VALUES(" + studentId[1] + "," + subject_id + "," + teacher_id +")";
