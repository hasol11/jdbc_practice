...
public class SchoolService {
	...
	public static void applySubject(String subject_name, int id) {
		...
		if(resultSubject == 1) {
			...
			int resultTakenSubject = TakenSubjectRepository.checkIsTakenSubject(subject_name, id);
			if(resultTakenSubject== 404) { // 나는 듣지 않은 수업 즉 수강신청 가능
				
				int result = TakenSubjectRepository.insertTakenSubject(subject_name, id);
